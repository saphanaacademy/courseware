...
-- BEFORE SPS11
DROP TABLE A_TA_LC_OLD_EXAMPLE CASCADE;
CREATE COLUMN TABLE A_TA_LC_OLD_EXAMPLE
(
ID INTEGER PRIMARY KEY, 
STRING nvarchar(200),
TXTLANG nvarchar(2)
...
INSERT INTO A_TA_LC_OLD_EXAMPLE VALUES (1, 'Bob really likes Manchester United.','EN');
INSERT INTO A_TA_LC_OLD_EXAMPLE VALUES (2, 'Ich hasse den FC Bayern München !!','DE');
INSERT INTO A_TA_LC_OLD_EXAMPLE VALUES (3, 'ボブは東京を楽しんで','JA');
INSERT INTO A_TA_LC_OLD_EXAMPLE VALUES (4, '밥은 서울을 즐긴다','KO');
INSERT INTO A_TA_LC_OLD_EXAMPLE VALUES (5, '鲍勃喜欢上海','ZH');

CREATE FULLTEXT INDEX myindex_lc_old ON A_TA_LC_OLD_EXAMPLE ("STRING")
CONFIGURATION 'EXTRACTION_CORE_VOICEOFCUSTOMER'
LANGUAGE COLUMN TXTLANG
TEXT ANALYSIS ON;

SELECT * FROM "$TA_MYINDEX_LC_OLD" ORDER BY ID;

...
SELECT
 NS.ST_AsWKT(),
 VN.ST_AsWKT(),
 VN.ST_DISTANCE(NS, 'kilometer') AS DIST_0,
 VN_1000004326.ST_DISTANCE(NS_1000004326, 'kilometer') AS DIST_1000004326,
 VN_4326.ST_DISTANCE(NS_4326, 'kilometer') AS DIST_4326
FROM A;
...
SELECT TRANSFORM_DEFINITION, SRS_ID 
...
DROP TABLE DEVTEST.GEOMULTIDIM;
CREATE COLUMN TABLE DEVTEST.GEOMULTIDIM (
	ID INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
 	GEO ST_GEOMETRY
 );  

INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POINT('POINT (5.0 6.0)'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POINT('POINT Z(5.0 6.0 8.0)'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POINT('POINT M(5.0 6.0 1400)'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POINT('POINT ZM(2 3 4 1000)'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POINT());
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_LINESTRING('LINESTRING ZM(3 3 4 2500, 5 4 2 2600, 6 3 3 2200)'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_LINESTRING());
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POLYGON('POLYGON ZM((6 7 4 1800, 10 3 4 1850, 10 10 4 1900, 6 7 4 1800))'));
INSERT INTO DEVTEST.GEOMULTIDIM 
	VALUES(NEW ST_POLYGON());
